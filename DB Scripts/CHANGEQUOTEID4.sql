--------------------------------------------------------
--  DDL for Procedure CHANGEQUOTEID4
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CHANGEQUOTEID4" is
...
begin
  ...
  for i in (select qm.quote_id,qm.prequote_id,terminal_id,version_no  from qms_Quote_master qm where  qm.id > 60000 order by quote_id,version_no)
  Loop
