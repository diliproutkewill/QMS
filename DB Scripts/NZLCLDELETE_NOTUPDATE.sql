--------------------------------------------------------
--  DDL for Procedure NZLCLDELETE_NOTUPDATE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "NZLCLDELETE_NOTUPDATE" is
begin
...
BEGIN
  FOR I IN (SELECT * FROM QMS_BUYRATES_DELETE1) LOOP
    V_COUNT1  := 0;
    V_QUOTEID := null;
    BEGIN
