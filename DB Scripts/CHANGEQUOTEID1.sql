--------------------------------------------------------
--  DDL for Procedure CHANGEQUOTEID1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CHANGEQUOTEID1" is
...
begin
  ...
  for i in (select qm.quote_id,qm.prequote_id,terminal_id,version_no  from qms_Quote_master qm where  qm.id BETWEEN 1500 AND 4999 order by quote_id,version_no)
  Loop
