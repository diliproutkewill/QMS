--------------------------------------------------------
--  DDL for Procedure CHANGEQUOTEID2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CHANGEQUOTEID2" is
...
begin
  ...
  for i in (select qm.quote_id,qm.prequote_id,terminal_id,version_no  from qms_Quote_master qm where  qm.id between 5000 and 30000 order by quote_id,version_no)
  Loop
