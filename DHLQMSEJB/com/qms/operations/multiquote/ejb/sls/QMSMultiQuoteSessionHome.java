 ...
 * File					: QMSMultiQuoteSessionHome.java
 * @author				: Govind
 * @date				: 
...
public interface QMSMultiQuoteSessionHome extends EJBHome 
{
  QMSMultiQuoteSession create() throws RemoteException, CreateException;
}