 ...
 * File					: QMSMultiQuoteSessionLocalHome.java
 * @author				: Govind
 * @date				: 
...
public interface QMSMultiQuoteSessionLocalHome extends EJBLocalHome 
{
  QMSMultiQuoteSessionLocal create() throws CreateException;
}