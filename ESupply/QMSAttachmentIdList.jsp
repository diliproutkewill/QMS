...
esupply - v 1.x.
Program	Name		: QMSAttachmentIdList.jsp
Product Name		: QMS
Module Name			: SetUp
...
<%!
	...
	private static final String FILE_NAME	=	"QMSAttachmentIdList.jsp ";  	
%>
...
<%
  ...
  QMSAttachmentDOB    dob					= new QMSAttachmentDOB();  
  ...
  SetUpSession        remote				= null;	
	...
	dob.setAttachmentId((attachmentId!=null)?attachmentId:"");
	dob.setLoginTerminal(loginbean.getTerminalId());
	...
	try
	{
        ...
        remote            =  home.create();
        attachmentIdList  =  remote.attachmentIdList(dob);
	...
	String 		fileName	    = "QMSAttachmentIdList.jsp";
   try
    {
	...
	if(event.keyCode == 13)
	{
		...
		else
		{
			temp 		= document.forms[0].AttachmentId.options[document.forms[0].AttachmentId.selectedIndex].value
			 window.opener.document.forms[0].attachmentId.value=temp;
		}
...
<b><center>Attachment Ids</center></b>
<b> <center>
<%
