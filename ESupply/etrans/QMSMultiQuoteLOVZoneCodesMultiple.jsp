...
esupply - v 1.x.
Program	Name		: QMSMultiQuoteLOVZoneCodesMultiple.jsp
Product Name		: QMS
Module Name			: Quote
Task				: 
...
<%!
  private static Logger logger = null;
	private static final String FILE_NAME	=	"QMSMultiQuoteLOVZoneCodesMultiple.jsp";
%>
...
<%
  logger  = Logger.getLogger(FILE_NAME);	
	...
	String  multiShipMode			=   request.getParameter("shipmentMode");
	...
	try
	{
		...
		ZoneCodesList 		=	remote.getZoneCodes(searchString1,searchString2,searchString3,multiShipMode,consoleType);
		 
			}
			else{
				
				ZoneCodesList 		=	remote.getZoneCodes(searchString1,multiShipMode,consoleType);
