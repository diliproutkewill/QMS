...
<%!
  private static Logger logger = null;
	private static final String FILE_NAME	=	"ETCLOVLocationIds1.jsp";
%>
...
<%
  logger  = Logger.getLogger(FILE_NAME);	
	...
	String module			= null;
	 ...
	 String		searchString3   = null;//added by phani sekhar for wpbn 171213 on 20090605
	 String rows=null;
    ...
    if(listHandler == null)
    {
		...
		searchString3	= request.getParameter("searchString3");
		...
		if(searchString3==null)
			...
			searchString3=searchString3.trim();
		//ends 171213
		...
		//Logger.info(FILE_NAME,"searchString2 : " +searchString2+" whereClause---> "+whereClause+" ArrayOrNot---> "+ArrayOrNot+"  wheretoset--->"+wheretoset);
		//if(locationIds==null)
		//{
...
//			locationIds						=	remote.getLocationIds(where_condition);
			if("".equals(searchString3))//added by phani sekhar for wpbn 171213 on 20090605
				{
			if(searchString2.equals("")){
				locationIds						=	remote.getLocationIds1(searchString,"Canada".equalsIgnoreCase(from)?"CANADA":operation,loginbean.getTerminalId(),shipMentMode);//added by rk
				...
				{
						if(!"".equals(searchString2))
							{
							locationIds						=	remote.getLocIds(searchString,searchString2,loginbean.getTerminalId(),operation,shipMentMode);
							}
							else
							locationIds						=	remote.getRegionalLocIds(searchString3,loginbean.getTerminalId(),operation,shipMentMode);
	...
	String 		fileName	= "ETCLOVLocationIds1.jsp";  
...
<%
	...
	{// begin of for loop
		...
		if(flag){
%>
		document.forms[0].locationNames.options[ <%= count %> ] = new Option("<%= str %>","<%=str%>","<%= str %>");
<%     count++;}flag=true;
	}//end of for loop
...
<TABLE cellSpacing=0 width="100%" align='center'>
  <tr  class="formdata"> 
	<td width="49%" align='center'>
		<select size="10" name="locationNames" MULTIPLE onKeyPress='onEnterKey()' class="select" style="width:300px;margin:0px 0 5px 0;">
		</select></td>
	<td width="2%" align='center' valign="middle">
		<input type="button" value='>>' name="right" class='input' onClick='moveDestSelectedRecords(document.forms[0].locationNames,document.forms[0].listTypes1)'><br>
	...
	<td width="49%" align='center'>
		<select size="10" name="listTypes1" MULTIPLE onDblClick='setlocationNames()' onKeyPress='onEnterKey()' class="select" style="width:300px;margin:0px 0 5px 0;">
		</select>
	</td>
 </tr>
</table>
