...
function compare(a, b)
{
	...
	else if(isTime(aRowContent[sortIndex]) && isTime(bRowContent[sortIndex]))
	{
		aToBeCompared = parseInt(aRowContent[sortIndex].substr(0,aRowContent[sortIndex].indexOf(":")))*60+parseInt(aRowContent[sortIndex].substr(aRowContent[sortIndex].indexOf(":")+1,aRowContent[sortIndex].length));
		
		bToBeCompared = parseInt(bRowContent[sortIndex].substr(0,bRowContent[sortIndex].indexOf(":")))*60+parseInt(bRowContent[sortIndex].substr(bRowContent[sortIndex].indexOf(":")+1,bRowContent[sortIndex].length));
...
function isTime(x)
{
	return (x.indexOf(":")!=-1 || x.indexOf(":")>1)?true:false;
}
