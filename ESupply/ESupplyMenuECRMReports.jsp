...
var browser = navigator.appName;
	...
	headers = new Array();
	headers[0] = '<U><fmt:message key="100049" bundle="${lang}"/></U>';
	...
	tables[0] = '<table '+B+'cellspacing="0">'+T+'ELCrmSOReport.jsp"><fmt:message key="100050" bundle="${lang}"/></a></td></tr>'+T+'ELCrmPendingSO.jsp"><fmt:message key="100051" bundle="${lang}"/></a></td><tr></FORM></tr>'+T+'ELCrmBackOrdersReport.jsp"><fmt:message key="100052" bundle="${lang}"/></a></td></tr>'+T+'ELCrmPartsReport.jsp"><fmt:message key="100053" bundle="${lang}"/> </a></td><tr></FORM></tr>'+T+'ELCrmInvoiceReport.jsp"><fmt:message key="100054" bundle="${lang}"/></a></td></tr></tr></table>';
