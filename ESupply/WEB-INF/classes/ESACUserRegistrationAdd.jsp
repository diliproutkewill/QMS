...
%>	 <td  width="34%"><fmt:message key="100210" bundle="${lang}"/><br>
            <input type="text" class='text' name="department" size="20" maxlength="25" value="<%= userModel.getDepartment() == null ? "" : userModel.getDepartment() %>" onBlur="stringFilter(this)" <%= readOnly %>>
		  </td>
...
%>		
    ...
    <td  width="34%"><fmt:message key="100210" bundle="${lang}"/><br>
            <input type="text" class='text' name="department" size="20" maxlength="25" value="<%= userModel.getDepartment() == null ? "" : userModel.getDepartment() %>" onBlur="stringFilter(this)" >
		  </td>
...
<%	//if(action!=null && action.equalsIgnoreCase("view")and ("Delete" )
		...
		{
%>	 <td  width="34%"><fmt:message key="100210" bundle="${lang}"/><br>
            <input type="text" class='text' name="department" size="20" maxlength="16" value="<%= userModel.getDepartment() == null ? "" : userModel.getDepartment() %>" onBlur="stringFilter(this)" <%= readOnly %>>
		  </td>
