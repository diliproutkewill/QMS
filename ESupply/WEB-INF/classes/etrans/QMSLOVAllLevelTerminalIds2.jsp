...
%
	...
	Program Name	:QMSLOVAllLevelTerminalIds2.jsp
	Module Name		:ETrans
	Task			:QMSLOVAllLevelTerminalIds2
	Sub Task		:QMSLOVAllLevelTerminalIds2
	Author Name		:
	Date Started	:
	Date Completed	:
	Date Modified	:
...
<%
	...
	BuySellChargesEnterIdDOB buySellChargesEnterIdDOB = null;//shyam
    ...
    if(listHandler == null)
    {
		...
		try
		    ...
		    customerIds				=   remote.getEmpIds(salesPersonCode,terminalId,loginbean.getUserLevel());
			...
			*/
			...
			buySellChargesEnterIdDOB	=	new BuySellChargesEnterIdDOB();
					...
					customerIds     =     remote.getTerminalListForBuyRSellCharges(buySellChargesEnterIdDOB,loginbean);
	...
	{
		Logger.error(FILE_NAME,"QMSLOVAllLevelTerminalIds2.jsp : " , e.toString());
	}
	}
	...
	String 		fileName	= "QMSLOVAllLevelTerminalIds2.jsp";  
    ...
    {
      Logger.error(FILE_NAME,"QMSLOVAllLevelTerminalIds2.jsp : " +ex);
    }
...
function submitForm(var1)
{
	...
	document.forms[0].action="QMSLOVAllLevelTerminalIds2.jsp?pageNo="+var1;
...
function setCustomerIds()
{
	...
	{
		alert("Please select atleast one  Terminal Id")
	}
	else
	{
...
%>
		var len		=<%=fromWhat%>;
		window.opener.setTerminalIdValues(document.forms[0].listTypes1,'<%=wheretoset%>');
		var cond 	='<%= ArrayOrNot%>' ;
		resetValues();
	}
<%
...
{
  closeWindow = 'false';
  document.forms[0].action="QMSLOVAllLevelTerminalIds2.jsp?pageNo="+<%=pageNo%>;
	document.forms[0].submit();
}
...
<center>
<b><font face="Verdana">Terminal Ids</font></b>
</center>
<br>
<%
...
<br><br>
<center>
<textarea cols=30 class='select' rows=6 readOnly >No TerminalIds available.
</textarea>
<br><br>
