...
%>
		...
		{
			 data="<table width='100%' cellpadding='4' cellspacing='1'><tr class='formdata'><td align='right' colspan='5' width='551'></td><td>Margin </td><td width='70' align='left' colspan='2'><input type=text  class='text' name='margenValue' size='7' value='<%=marginValues[0]%>'></td><td width='108' align='left' colspan='4'><input type=text  class='text' name='margenValue' size='7'  value='<%=marginValues[1]%>'></td></tr>";
