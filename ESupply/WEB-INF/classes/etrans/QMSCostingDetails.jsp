...
<!--@@Modified by subrahmanyam for 213788-->
					...
					<td>MIN</td>
					 ...
					 <%}}%>
							...
							else if(rateDetailsDOB.getWeightBreakSlab().endsWith("CAF%")||rateDetailsDOB.getWeightBreakSlab().endsWith("caf")||rateDetailsDOB.getWeightBreakSlab().equalsIgnoreCase("SURCHARGE"))
								 {%>
			  ...
			  %>
				...
				<%if(tempAbs == 1 && tempDesc.equalsIgnoreCase(detailsDOB.getRateDescription())){%>
					...
					<%
					  ...
					  <td>Per Kilogram</td>
					   <%}
					  else if("BAFM3".equalsIgnoreCase(rateDetailsDOB.getWeightBreakSlab())||"PSSM3".equalsIgnoreCase(rateDetailsDOB.getWeightBreakSlab()))
						{%>
						...
						<td>Percent of Freight</td>
						 <%}
					  else if("CSF".equalsIgnoreCase(rateDetailsDOB.getWeightBreakSlab()))
					  {%>
						<td>Per Shipment</td>
					 <%}
