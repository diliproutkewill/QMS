  ...
  <%
				...
				//End of  kishore For SCH Currency
				  ...
				  <%for(int m=count;m<wtBreakLength;m++)
				  {
					 ...
					 if(weighttBkValues[m]!=null&&weighttBkValues[m]!="" && diffDesc !=null && diffDesc.length()>0 && (ratedesc[m].equalsIgnoreCase(diffDesc) ))
					  {
						 desCount++;
						 if("2".equals(shipmentMode)&&"FCL".equals(consoleTpe))
						  {
							...
							weighttBkValues[m] = weighttBkValues[m].length() > 5?weighttBkValues[m].substring(5,weighttBkValues[m].length()):weighttBkValues[m]; // Added by Kishore on 15Feb2011 to display slabs as min,slab and flat etc
