	   ...
	   (document.forms[0].QuoteType.options[document.forms[0].QuoteType.selectedIndex].value=='Truck Export'))
		{
		  ...
		  Url='etrans/QMSQuoteIdsLOV1.jsp?customerId='+document.forms[0].customerId.value+'&searchString='+document.forms[0].QuoteId.value+'&whereToSet='+input+'&originLoc='+origin+'&destLoc='+destAppend+'&operation='+operation+'&quoteType='+shipMode;
	    ...
	    else
        {
		   ...
		   originAppend=originAppend.substring(0,(originAppend.length-1)); Url='etrans/QMSQuoteIdsLOV1.jsp?customerId='+document.forms[0].customerId.value+'&searchString='+document.forms[0].QuoteId.value+'&whereToSet='+input+'&originLoc='+originAppend+'&destLoc='+destination+'&operation='+operation+'&quoteType='+shipMode;
		   Options='width=600,height=300,resizable=no';
