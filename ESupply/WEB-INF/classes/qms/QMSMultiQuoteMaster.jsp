...
%>
		...
		<tr class="formdata">
			...
			Cust Req Date 
				<%if("Add".equalsIgnoreCase(operation)){%>
				<input class="text" maxLength="25" name="custDate"  size="10" value="<%=currentDate%>" onBlur="changeToUpper(this);extend(this);return dtCheck(this)">
				<%}else{%>
				<input class="text" maxLength="25" name="custDate"  size="10" value="<%=custDate!=null?custDate:""%>" onBlur="changeToUpper(this);extend(this);return dtCheck(this)">				
				<%}%>
