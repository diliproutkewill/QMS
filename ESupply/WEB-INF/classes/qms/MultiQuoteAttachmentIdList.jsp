...
esupply - v 1.x.
Program	Name		: MultiQuoteAttachmentIdList.jsp
Product Name		: QMS
Module Name			: Quote
...
<%!
	...
	private static final String FILE_NAME	=	"MultiQuoteAttachmentIdList.jsp ";  	
%>
...
<%
  ...
  MultiQuoteAttachmentDOB   attachmentDOB         = new MultiQuoteAttachmentDOB();
