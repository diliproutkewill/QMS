...
<input class="input" type="button" name="chargeGroupIdDet" value="VeiwDetails" onclick="popUpWindow(this,<%=i%>,0)"></td>
...
<tr class="formdata"><td valign ='bottom' colspan="9"><b>Weight Break: </b><%=masterDOB.getMultiquoteweightBrake()%><input type="hidden" name="spotRateType<%=i%>" value="<%=masterDOB.getMultiquoteweightBrake()%>"></td></tr>
 ...
 <% if((!"Modify".equalsIgnoreCase(masterDOB.getOperation()) && !"BackButton".equalsIgnoreCase(backButton)) || ("Modify".equalsIgnoreCase(masterDOB.getOperation()) && "INCOMPLETE".equalsIgnoreCase(completeFlag)) ){
