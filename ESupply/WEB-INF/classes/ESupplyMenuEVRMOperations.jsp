...
var browser = navigator.appName;
	...
	headers = new Array();
	headers[0] = '<U><fmt:message key="100528" bundle="${lang}"/></U>';
	headers[1] = '<U><fmt:message key="100529" bundle="${lang}"/></U>';
	headers[2] = '<U><fmt:message key="100517" bundle="${lang}"/></U>';
	for (i = 0; i<3;i++)
	{
	...
	tables = new Array();
tables[0] = '<table '+B+' cellspacing="0">'+T+'ELVendorInvoiceController.jsp?Process=ADD">&nbsp;&nbsp;<fmt:message key="100506" bundle="${lang}"/>&nbsp;&nbsp;</a></td></tr>' + T + 'ELVendorInvoiceController.jsp?Process=MODIFY">&nbsp;&nbsp;<fmt:message key="100513" bundle="${lang}"/>&nbsp;&nbsp;</a></td></tr>' + T + 'ELVendorInvoiceController.jsp?Process=VIEW">&nbsp;&nbsp;<fmt:message key="100507" bundle="${lang}"/>&nbsp;&nbsp;</a></td></tr>' + T + 'ELVendorInvoiceController.jsp?Process=MANUAL">&nbsp;&nbsp;<fmt:message key="100530" bundle="${lang}"/>&nbsp;&nbsp;</a></td></tr></table>';
	//tables[0] = '<table '+B+' cellspacing="0">'+T+'.jsp">Add</a></td><tr></FORM></tr>'+T+'.jsp">View</a></td><tr></FORM></tr></table>';
	tables[1] = '<table '+B+' cellspacing="0">'+T+'ELDeliveryScheduleController.jsp?Process=MODIFY"><fmt:message key="100513" bundle="${lang}"/></a></td></tr>'+T+'ELDeliveryScheduleController.jsp?Process=VIEW"><fmt:message key="100507" bundle="${lang}"/></a></td><tr></FORM></tr></table>';
	tables[2] = '<table '+B+' cellspacing="0">'+T+'ELPurchaseOrderController.jsp?Process=ADD">&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="100506" bundle="${lang}"/>&nbsp;&nbsp;&nbsp;&nbsp;</a></td></tr>'+T+'ELPurchaseOrderController.jsp?Process=MODIFY">&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="100513" bundle="${lang}"/>&nbsp;&nbsp;&nbsp;&nbsp;</a></td></tr>' + T + 'ELPurchaseOrderController.jsp?Process=VIEW">&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="100507" bundle="${lang}"/>&nbsp;&nbsp;&nbsp;&nbsp;</a></td></tr></table>';
	//	tables[2] = '<table '+B+' cellspacing="0">'+T+'.jsp">&nbsp;&nbsp;&nbsp;&nbsp;Add&nbsp;&nbsp;&nbsp;&nbsp;</a></td></tr>'+T+'.jsp">&nbsp;&nbsp;&nbsp;&nbsp;Modify&nbsp;&nbsp;&nbsp;&nbsp;</a></td></tr>' + T + '.jsp">&nbsp;&nbsp;&nbsp;&nbsp;View&nbsp;&nbsp;&nbsp;&nbsp;</a></td></tr></table>';
