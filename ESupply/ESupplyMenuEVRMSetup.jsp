...
var browser = navigator.appName;
	...
	headers = new Array();
	headers[0] = '<U><%=bundle.getBundle().getString("100510")%></U>';
	headers[1] = '<U><%=bundle.getBundle().getString("100511")%></U>';
	headers[2] = '<U><%=bundle.getBundle().getString("100512")%></U>';
	...
	tables = new Array();
	tables[0] = '<table '+B+' cellspacing="0">'+T+'ELPartyMasterVendorVRMModify.jsp?Process=MODIFY&partyFlag=VENDOR"><%=bundle.getBundle().getString("100513")%></a></td></tr>'+T+'ELPartyMasterVendorVRMView.jsp?Process=VIEW&partyFlag=VENDOR"><%=bundle.getBundle().getString("100507")%></a></td><tr></FORM></tr></table>';
	tables[1] = '<table '+B+' cellspacing="0">'+T+'ELPartVendorController.jsp?Process=MODIFY&flag=VENDOR"><%=bundle.getBundle().getString("100513")%></a></td></tr>'+T+'ELPartVendorController.jsp?Process=VIEW&flag=VENDOR"><%=bundle.getBundle().getString("100507")%></a></td></tr></table>';
	tables[2] = '<table '+B+' cellspacing="0">'+T+'ELPurchaseContractController.jsp?Process=MODIFY">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=bundle.getBundle().getString("100513")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td><tr>'+T+'ELPurchaseContractController.jsp?Process=VIEW">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=bundle.getBundle().getString("100507")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td><tr></FORM></tr></table>';

	if(is_ns4())
	{
		document.open();
		document.write('<layer width="100%" top="0" left="0"><table cellspacing="0" width="100%"><tr><td class="menu"><a href="http://www.four-soft.com"><%=bundle.getBundle().getString("100048")%></a></td></tr></table></layer>\n');
		 for(i=0;i<4;i++)
		 {
	...
	{
		document.write('<div style="position:absolute; width:100%; top:0;"><table cellspacing="0" width="100%"><tr><td class="menu" width="100%"><a href="http://www.four-soft.com"><%=bundle.getBundle().getString("100048")%></a></td></tr></table></div>');
		if(is_ie())
		{
			for(i = 0; i < 4; i++)
			{
