	...
	function openQuote(uniqueId,sellBuyFlag,changeDesc,quoteId,index)
{
	//	alert(index);
		...
		else commented by govind  for not getting the pop-up for Quote when clicking hyper link*/
			var isMultiQuoteVal = document.getElementsByName("isMultiQuote")[index].value
