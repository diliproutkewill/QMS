...
<%!
      ...
      private static final  String  FILE_NAME = "QMSActivityReportPreInfo.jsp" ;
%>
<%
...
//@@ Ended by subrahmanyam  for the pbn id:220125 on 07-oct-10
	...
	url='<%=request.getContextPath()%>/etrans/ETCLOVMultipleSalesPerson.jsp?&wheretoset=salesPersonCode+&terminalId='+ids+'&fromWhere=activityReport';//@@ Modified by subrahmanyam  for the pbn id:220125 on 07-oct-10
		  ...
		  <td>
			...
			<table width="100%" cellpadding="4" cellspacing="1">
			  <tr valign="top" class='formlabel'>
				...
				Activity Report</td><td align='right'><!-- Screen Id goes here --></td></tr></table></td>
			  </tr>
	 </table>
...
<!-- @@ Added by subrahmanyam for the WPBN ISSUE:150461 ON 19/12/2008 -->
          ...
          <input type='checkbox' name='autoUpdated' value='UPD'>Updated <br><!--@@Added by VLAKSHMI for the WPBN issue-154389-->
              ...
              <tr class="text" vAlign="top">
                ...
                <td colspan="2" align='right'>
				  ...
				  <input type="hidden" name='Operation' value="getActivityDetails">
                </td>
              </tr>
