   ...
   <td>
	...
	<table width="100%" cellpadding="1" cellspacing="1" border="0">
    	...
    	<tr class="formdata" valign="top">
		  ...
		  <td id=idType><fmt:message key="100268" bundle="${lang}"/> <font face="verdana" size=1 color="#FF0000"><fmt:message key="9999" bundle="${lang}"/></font></td>
...
%>
		  ...
		  <td>
		  	<input type="text" name="locationId" value="<%= locationId %>" onBlur = "specialCharFilter(this);stringFilter(this)">
			  <input type="button" value="..." name="locBtn" onClick = 'return openLocWin()' class="input">
		  </td>
		
		  <td>
			<input type="text" name="<%= idName %>" size="20" onBlur = "specialCharFilter(this);stringFilter(this)">
	...
	<table width="100%" cellpadding="4" cellspacing="1" border="0">
		<tr>
		  ...
		  <td colspan=2 align="right">
        	...
        	<input type="submit" value='<fmt:message key="6666" bundle="${lang}"/>'  name="B1" class="input">
