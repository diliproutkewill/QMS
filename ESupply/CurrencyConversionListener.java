...
public final class CurrencyConversionListener implements ServletContextListener,
               NotificationListener 
{
    private static final long PERIOD = Timer.ONE_DAY;
    private Timer timer;
    private Integer notificationId;
    private static final String FILE_NAME = "CurrencyConversionListener.java";
    public void contextInitialized(ServletContextEvent event) 
	 {
    	Logger.info(FILE_NAME,">>> contextInitialized called.");
       ...
       */
       ...
       //below commented cod is to fire the timer event starting at this time
       ...
       timer.start();
       Logger.info(FILE_NAME,">>> timer started.");
}
public void contextDestroyed(ServletContextEvent event)	
{
   Logger.info(FILE_NAME,">>> contextDestroyed called.");
    try 
	{
       timer.stop();
       timer.removeNotification(notificationId);
       Logger.info(FILE_NAME,">>> timer stopped.");
    }
 ...
 public void handleNotification(Notification notif, Object handback) 
 {
    //System.out.println(">>> "+(new Date())+" timer handleNotification="+notif+", handback="+handback);
	 Logger.info(FILE_NAME,">>> handleNotification called.");
    ...
    Logger.info(FILE_NAME,">>> handleNotification ended.");
 }
