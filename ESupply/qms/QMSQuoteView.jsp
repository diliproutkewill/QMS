...
%>
					<tr class="formdata" cellpadding="4" align=center>
					  ...
					  <!--@@Modified by Kameswari for Surcharge Enhancements-->
						...
						{
						 %>
						 <td><%=(chargeInfo.getRateDescription()!=null && !"".equals(chargeInfo.getRateDescription()) && !"A FREIGHT RATE".equalsIgnoreCase(chargeInfo.getRateDescription()) && !"FREIGHT RATE".equalsIgnoreCase(chargeInfo.getRateDescription()))?chargeInfo.getRateDescription().substring(0,chargeInfo.getRateDescription().length()-3):"FREIGHT RATE"%></td>
					 <%
