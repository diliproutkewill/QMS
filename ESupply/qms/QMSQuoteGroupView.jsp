...
esupply - v 1.x.
Program	Name	: QMSQuoteGroupView.jsp
Product Name	: QMS
Module Name		: Quote
Task		    : Adding
Date started	:
...
<%!
	private static final String FILE_NAME="QMSQuoteGroupView.jsp";
...
<%
	...
	try
	{
		...
		{
		finalDOB		      =	(QuoteFinalDOB)mainDtl.get(k);
...
%>
       <table width="100%" cellpadding="4" cellspacing="1" bgcolor='#FFFFFF'>
		<tr class="formdata">
              <td>QUOTEID : <%=masterDOB.getQuoteId()%></td>
			  <td colspan="7" >&nbsp;&nbsp;ORIGIN &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<%=headerDOB.getOriginLocName()!=null?headerDOB.getOriginLocName().toUpperCase():""%>  </td>
		<tr class="formdata">
			  <td>&nbsp;</td>
			  <td colspan="7">&nbsp; DESTINATION&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<%=headerDOB.getDestLocName()!=null?headerDOB.getDestLocName().toUpperCase():""%></td>
            </tr>
			<tr class="formdata">
              <td>&nbsp;</td>
...
<!-- @@ Added by subrahmanyam for the WPBN ISSUE: 150460 ON 23/12/2008 -->
			...
			{%>
				 <td colspan="4" >Place Of Acceptance:</td>
			<%}else{%>
...
<!-- @@ Ended by subrahmanyam for the WPBN ISSUE:150460 ON 23/12/2008 -->
			...
			<tr class="formdata">
			  ...
			  <td colspan="4" ><%=headerDOB.getOriginPortName()!=null?headerDOB.getOriginPortName()+", ":""%><%=headerDOB.getOriginPortCountry()!=null?headerDOB.getOriginPortCountry().toUpperCase():""%></td>
            </tr>
			<tr class="formdata">
              <td colspan="4">Destination Port: </td>
			  <td colspan="4"><%=headerDOB.getDestPortName()!=null?headerDOB.getDestPortName()+", ":""%><%=headerDOB.getDestPortCountry()!=null?headerDOB.getDestPortCountry().toUpperCase():""%></td>
            </tr>
