...
esupply - v 1.x.
Program	Name	: QMSMultiQuoteChargeGroups.jsp
Product Name	: QMS
Module Name		: 
Date started	: 13-01-2011
Date Completed	: 
Date modified	:  
Author    		: K Rakesh
...
<%!
	private static final String FILE_NAME="QMSMultiQuoteChargeGroups.jsp";
%>
...
<script>
  ...
  <body>
	<form method='POST'  action="QMSMultiQuoteController" onSubmit=''>
	  ...
	  <tr class='denotes'>             
			...
			<%System.out.println("ROcky "+request.getParameter("Operation"));%>
