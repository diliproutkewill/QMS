...
var browser = navigator.appName;
	...
	headers = new Array();
	headers[0] = '<U><fmt:message key="100514" bundle="${lang}"/></U>';
	...
	tables[0] = '<table '+B+'cellspacing="0">'+T+'ELVRMInventoryReport.jsp"><fmt:message key="100515" bundle="${lang}"/></a></td></tr>'+T+'ELVRMContractsReport.jsp"><fmt:message key="100516" bundle="${lang}"/></a></td><tr></FORM></tr>'+T+'ELVrmPOReport.jsp"><fmt:message key="100517" bundle="${lang}"/></a></td></tr>'+T+'ELVrmPendingReportDtl.jsp"><fmt:message key="100518" bundle="${lang}"/></a></td><tr>'+T+'ELPartTransactionIndex.jsp?Choice=PartTransactionHistory"><fmt:message key="100519" bundle="${lang}"/></a></td><tr></FORM></tr><tr>'+T+'ELPartPackIndex.jsp"><fmt:message key="100520" bundle="${lang}"/></a></td><tr></FORM></tr></table>';
